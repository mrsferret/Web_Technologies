...
// Example Shopping Cart (cart.php)
// Create Cart Page 
// Create a separate cart page, where users can:
// View a list of items in their cart.
// Remove items from the cart.
// Update the quantity of each item in the cart.
// View the subtotal, tax, and total price of the items in the cart.
// Proceed to a (mock) checkout process.
//=========================================================================
